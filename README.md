...
- **Disable Miui Optimization from Developer Option to use in Miui/HyperOS and apply the font systemwide and proper weight/style application, (still) not guranteed it will work with every version of Miui**
